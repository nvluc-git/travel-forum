...
const runStore = async () => {
  ...
  await useArticles.onGetQuestionUser();
};
runStore();
...
<template>
  ...
  <div class="container pb-5 pt-5">
    <h1 class="text-dark">Question Management</h1>
      ...
      <div>
        <span class="p-input-icon-left">
          ...
          <InputText
            ...
            name="search"
            id="search"
            v-model="useArticles.search_QuestionUser"
          />
        </span>
        <button
          ...
          @click="visible3 = true"
        >
          New question <i class="bi bi-vector-pen"></i>
        </button>
      </div>
      <div>
    ...
    <div
      v-if="useArticles.searchQuestionUser <= 0"
    ...
    <div class="box-post gap-5 flex-wrap">
      <div
        ...
        v-for="(item, index) in useArticles.searchQuestionUser"
        :key="index"
      >
      ...
      <div class="container">
        ...
        >
          ...
          <div class="mb-4" style="display: none">
            <h6>Type</h6>
            <Field name="typeId" class="form-select" value="2" />
            <ErrorMessage class="err-mess" name="typeId" />
          </div>
